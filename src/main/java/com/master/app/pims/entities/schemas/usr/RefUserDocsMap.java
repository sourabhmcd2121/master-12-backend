package com.master.app.pims.entities.schemas.usr;
...
@AllArgsConstructor
@Entity
@Table(name = "ref_user_docs_map", schema = "usr")
public class RefUserDocsMap implements Serializable{

	private static final long serialVersionUID = 1L;

	@Id
	@Basic(optional = false)
	@Column(name = "user_docs_map_guid")
	private String userDocsMapGuid;
	...
	public RefUserDocsMap(String userDocsMapGuid) {
		super();
		this.userDocsMapGuid = userDocsMapGuid;
	}
