...
@AllArgsConstructor
@Entity
@Table(name = "ref_education_map", schema = "rbd")
public class RbdRefEducationMap implements Serializable{

	private static final long serialVersionUID = 1L;

	@Id
    @Basic(optional = false)
    @Column(name = "education_map_guid")
    private String educationMapGuid;
    @Transient
    ...
    @JoinColumn(name = "education_level_guid", referencedColumnName = "education_level_guid")
    @ManyToOne(optional = false)
    private EducationLevel educationLevelMaster;

	public RbdRefEducationMap(String educationMapGuid) {
		super();
		this.educationMapGuid = educationMapGuid;
	}
